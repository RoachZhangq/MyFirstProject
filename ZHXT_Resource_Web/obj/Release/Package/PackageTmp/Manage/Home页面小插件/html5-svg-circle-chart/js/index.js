$(function () {
    $.get("/Manage/Ajax/GetHomeChart.ashx", {}, function (data) {
        if (data.result) {
            var arr = [];
            var colorArr = ["#2C3E50", "#FC4349", "#6DBCDB", "#F7E248", "#D7DADB", "#FFF",
                "#CD2626", "#9BCD9B", "#9370DB", "#71C671", "#436EEE", "#8B5A2B", "#8DB6CD",
                "#A0522D", "#CD3278", "#EE9572", "#8B3E2F", "#5E5E5E", "#2E8B57"]
            ...
            $("#doughnutChart").drawDoughnutChart(arr);
           
            //setTimeout(function () { 
            //    $(".doughnutSummaryTitle").html("资料总数：");
            //    $(".doughnutSummaryNumber").html(parseInt($(".doughnutSummaryNumber").html()));
            //}, 1000);
        }
    }, "json");
